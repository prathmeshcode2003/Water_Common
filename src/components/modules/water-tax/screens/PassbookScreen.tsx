...
export function PassbookScreen({ user, onNavigate }: PassbookScreenProps) {
  ...
  return (
    // Remove fixed/inset-0/overflow-hidden, use a normal div and wrap content in <main>
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-cyan-50 pt-4 sm:mt-[75px]">
      {/* Animated Background */}
      ...
      <div className="relative z-10 w-full px-6 py-4 flex-1 flex flex-col overflow-hidden">
        {/* PAGE HEADER */}
         <div className="flex-shrink-0 bg-white/95 backdrop-blur-sm shadow-md rounded-xl border-2 border-blue-200 mb-3 px-6 py-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 px-0 py-2 sm:py-3">
        ...
        <Card className="mb-3 p-0 sm:p-5 bg-white/90 backdrop-blur-sm shadow-lg border-2 border-blue-200">
                ...
                <tbody>
                  {transactions.map((transaction, index) => (
                    ...
                    >
                      ...
                      <td className="px-2 sm:px-3 py-2 sm:py-3 text-xs sm:text-sm text-gray-900 border-r border-gray-200">
                        <span
                          className={`inline-flex items-center px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-[10px] sm:text-xs font-semibold whitespace-nowrap ${
