...
import { clearCitizenSession } from "@/app/water-tax/citizen/actions";
import { useRouter } from "next/navigation";
import { Dialog, DialogContent } from "@/components/common/Water.Citizen/Dialog";
import { NewConnectionFormContent } from "./NewConnectionForm";
...
const Support = () => <div>Support Component</div>;
const RTIInfo = () => <div>RTIInfo Component</div>;
  ...
  return (
    <main className="relative z-10 px-4 sm:px-6 lg:px-8 py-2 sm:py-3">
      ...
      <div className="flex flex-col lg:flex-row gap-3 items-stretch">
        ...
        <Card className="hidden lg:block lg:flex-1 lg:min-w-0 h-fit bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 border-2 border-blue-300 shadow-md overflow-hidden p-[0px]">
