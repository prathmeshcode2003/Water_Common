...
export function BillCalculatorScreen({ onNavigate }: BillCalculatorScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 p-3 sm:p-4 md:p-6 pb-20 sm:pb-6">
      <motion.div
        ...
        {/* <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Estimate your water bill</p>
            </div>
          </div>
        </div> */}
