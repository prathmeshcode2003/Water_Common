    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <motion.div
          ...
          className="w-[80vw] h-auto max-h-[95vh] overflow-hidden bg-white rounded-lg shadow-2xl flex flex-col"
        >
          {/* Header */}
          <div className="border-b bg-gradient-to-r from-blue-500 to-cyan-600 px-4 py-3">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-xl flex items-center gap-2 text-white font-bold">
              ...
              {/* Connection Selector */}
              <div className="ml-4 min-w-[320px] bg-gradient-to-r from-cyan-400 to-teal-500 p-3 rounded-xl shadow-lg border-2 border-cyan-300">
                ...
                >
                  ...
                  {availableConnections.map((connection) => (
                    <option key={connection.id} value={connection.id}>
                      {connection.consumerNo} | {connection.connectionType} |{" "}
                      {connection.category}
                    </option>
                  ))}
                </select>
              ...
              <Button
                ...
                size="sm"
                onClick={onClose}
                className="ml-3 h-8 w-8 p-0 bg-white/20 border-white/30 hover:bg-white/30 text-white"
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
                    ...
                    <div className="p-3 space-y-2">
                      ...
                      <div className="grid grid-cols-12 gap-2">
                        ...
                        <div className="col-span-3">
                          ...
                          >
                            <option value="15mm (1/2 inch)">
                              15mm (1/2 inch)
                            </option>
                            <option value="20mm (3/4 inch)">
                              20mm (3/4 inch)
                            </option>
                          ...
                          <table className="w-full">
                            <thead>
                              <tr className="bg-gradient-to-r from-purple-100 via-pink-100 to-blue-100 border-b-2 border-purple-200/50">
                                <th className="px-2 py-1 text-left text-xs text-purple-900 font-extrabold">
                                  Sr. No
                                </th>
                                <th className="px-2 py-1 text-left text-xs text-purple-900 font-extrabold">
                                  Document Name
                                </th>
                                <th className="px-2 py-1 text-center text-xs text-purple-900 font-extrabold">
                                  Type
                                </th>
                                <th className="px-2 py-1 text-center text-xs text-purple-900 font-extrabold">
                                  Status
                            ...
                            <tbody>
                              {[
                                ...
                                return (
                                  <tr
                                    key={index}
                                    className="border-b border-purple-100/50 hover:bg-purple-50/30 transition-colors"
                                  >
                                    ...
                                    <td className="px-2 py-1.5 text-center">
                                      <span
                                        className={`inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold ${doc.type === "Required"
                                    ...
                                    <td className="px-2 py-1.5 text-center">
                                      <span
                                        className={`inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-semibold ${isUploaded
              ...
              <div className="p-6">
                <div className="bg-gray-100 rounded-lg p-8 text-center">
                  ...
                  <p className="text-xs text-gray-500">
                    Size: {(viewingDocument.file.size / 1024).toFixed(2)} KB
                  </p>
