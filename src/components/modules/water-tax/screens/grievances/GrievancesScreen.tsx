...
import { GrievancesMobileView } from "./GrievancesMobileView";
...
export function GrievancesScreen({ onNavigate, grievances: propGrievances, user }: GrievancesScreenProps) {
  ...
  // Use prop grievances if provided, otherwise fallback to mock data
  const grievances = propGrievances || [
    {
      id: "GRV-2026-023",
  ...
  return (
    <>
      ...
      <div className="lg:hidden">
        <GrievancesMobileView onNavigate={onNavigate} />
      </div>
      ...
      <div className="hidden lg:flex items-center justify-center h-fit overflow-hidden bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 pt-4 sm:mt-[50px] pb-16 sm:pb-0">
        ...
        <div className="w-full h-full flex flex-col px-3 sm:px-6 py-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-2 mb-2">
            ...
            >
              <Card
                className={`p-3 sm:p-4 lg:p-5 shadow-lg border ${activeTab === "all"
            ...
            >
              <Card
                className={`p-3 sm:p-4 lg:p-5 shadow-lg border ${activeTab === "open"
            ...
            >
              <Card
                className={`p-3 sm:p-4 lg:p-5 shadow-lg border ${activeTab === "resolved"
            ...
            >
              <Card
                className={`p-3 sm:p-4 lg:p-5 shadow-lg border ${activeTab === "closed"
          ...
          <div className="flex gap-2 mb-2">
            <Button
              ...
              className={`flex-1 h-9 text-xs ${activeTab === "all"
            ...
            <Button
              ...
              className={`flex-1 h-9 text-xs ${activeTab === "open"
            ...
            <Button
              ...
              className={`flex-1 h-9 text-xs ${activeTab === "resolved"
            ...
            <Button
              ...
              className={`flex-1 h-9 text-xs ${activeTab === "closed"
            ...
            <Card className="p-0 shadow-lg border-0 bg-white/90 backdrop-blur-sm overflow-hidden h-full flex flex-col">
              <div className="flex-1 overflow-y-auto">
                <table className="w-full">
                  <thead
                    className={`text-white sticky top-0 z-10 ${activeTab === "all"
